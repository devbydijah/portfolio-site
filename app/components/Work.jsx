    ...
    >
      ...
      <motion.div
        ...
        {workData.map((project, index) => (
          <a href={project.repoLink} target="_blank" rel="noopener noreferrer" key={index}>
            <motion.div
            ...
            >
              <div className="bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
                ...
                <div className="border rounded-full border-black w-9 aspect-square flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lime-300 translate-y-1">
