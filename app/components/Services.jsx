  ...
  return (
    <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
        I partner with clients to bring their digital vision to life. My
        services include website development, web application design, and mobile
        app development with React Native, all with a focus on creating engaging
